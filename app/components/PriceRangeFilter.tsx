...
export default function PriceRangeFilter({
  ...
  return (
    <div className="space-y-5 rounded-md border border-white/40 bg-white/30 p-5 shadow-[0_12px_30px_rgba(15,23,42,0.12)] backdrop-blur-xl">
          ...
          {unitButtons.map((unit) => {
            ...
            return (
              <button
                ...
                className={`flex items-center gap-1 whitespace-nowrap rounded-md px-2.5 py-2 text-xs font-medium transition ${
                  active
                    ? "bg-[#0c1d2f] text-white"
                    : "border border-white/50 bg-white/45 text-[#192a3a] backdrop-blur-md hover:bg-white/60"
                }`}
              >
      ...
      <div>
        ...
        <div className="mb-4 flex gap-4">
          <div className="flex-1">
            ...
            <input
              ...
              className="w-full rounded-md border border-white/50 bg-white/60 px-4 py-3 text-sm backdrop-blur-md"
            />
          </div>
          ...
          <div className="flex-1 text-right flex flex-col items-end">
            ...
            <div className="w-full flex justify-end">
              <input
                ...
                className="w-auto min-w-[120px] text-right rounded-md border border-white/50 bg-white/60 px-4 py-3 text-sm backdrop-blur-md"
              />
            </div>
          </div>
        </div>
        ...
        <div className="relative px-1 py-4">
          <div className="absolute left-1 right-1 top-1/2 h-2 -translate-y-1/2 rounded-full bg-white/70" />

          <div
            className="absolute top-1/2 h-2 -translate-y-1/2 rounded-full bg-[#0c1d2f]"
            style={{
              left: `${minPercent}%`,
          ...
          <input
            ...
            [&::-webkit-slider-thumb]:border-[#ef4444]
