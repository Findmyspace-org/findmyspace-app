...
export default function HomePage() {
  ...
  return (
      ...
      <section className="relative flex w-full flex-col overflow-hidden max-md:h-[100dvh] max-md:max-h-[100dvh] max-md:min-h-0 md:block md:h-auto md:max-h-none md:min-h-0 md:overflow-visible lg:min-h-[640px] xl:min-h-[700px]">
        ...
        />
        <div
          className="pointer-events-none absolute inset-0 bg-gradient-to-t from-black/30 via-transparent to-transparent md:hidden"
          aria-hidden
        />
        {/* Desktop: subtle left scrim for headline legibility only */}
        <div
          className="pointer-events-none absolute inset-0 hidden bg-gradient-to-r from-white/50 via-white/18 to-transparent sm:from-white/45 sm:via-white/14 md:block"
          aria-hidden
        />
